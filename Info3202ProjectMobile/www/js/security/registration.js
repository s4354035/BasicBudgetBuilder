...
angular.module('mainApp')
    .controller("registrationController",['$scope', '$http', '$state', 'BASE_CONSTS', function($scope, $http, $state, BASE_CONSTS){
        var view = $scope;
        view.newUser = {};
        view.error = false;
        view.registration = function(){
            ...
            $http.post(BASE_CONSTS.ip + 'registration', view.newUser)
                .then(
                    function () {
                        $state.go("login");
                    },
